            ...
            <div className="w-full max-w-6xl mx-auto py-12 px-6">
              ...
              <AnimCard delay={0.2} className="bg-white/10 rounded-2xl shadow-xl backdrop-blur-md border border-white/10 p-8 mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {/* int Card */}
                  <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 rounded-xl p-4 sm:p-5 border-l-4 border-pink-500 shadow-md transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <code className="text-xl sm:text-2xl font-bold text-pink-300">int</code>
                      <span className="bg-pink-500/30 text-pink-200 px-2 py-1 rounded text-[10px] sm:text-xs font-bold">4 bytes</span>
                    </div>
                    <p className="text-blue-200 text-xs sm:text-sm">Integer values - whole numbers</p>
                    <div className="bg-black/50 rounded-lg p-3 mt-3 font-mono text-xs sm:text-sm">
                    ...
                    <div className="mt-3 text-[10px] sm:text-xs text-blue-300">
                      <div>📊 Range: -2.1B to 2.1B</div>
                      <div>📝 Format: %d | %i</div>
                    </div>
                  </div>

                  {/* char Card */}
                  <div className="bg-gradient-to-br from-orange-500/20 to-amber-500/20 rounded-xl p-4 sm:p-5 border-l-4 border-orange-500 shadow-md transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <code className="text-xl sm:text-2xl font-bold text-orange-300">char</code>
                      <span className="bg-orange-500/30 text-orange-200 px-2 py-1 rounded text-[10px] sm:text-xs font-bold">1 byte</span>
                    </div>
                    <p className="text-blue-200 text-xs sm:text-sm">Single character / ASCII values</p>
                    <div className="bg-black/50 rounded-lg p-3 mt-3 font-mono text-xs sm:text-sm">
                  ...
                  {/* float Card */}
                  <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl p-4 sm:p-5 border-l-4 border-blue-500 shadow-md transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <code className="text-xl sm:text-2xl font-bold text-blue-300">float</code>
                      <span className="bg-blue-500/30 text-blue-200 px-2 py-1 rounded text-[10px] sm:text-xs font-bold">4 bytes</span>
                    </div>
                    <p className="text-blue-200 text-xs sm:text-sm">Single precision floating point</p>
                    <div className="bg-black/50 rounded-lg p-3 mt-3 font-mono text-xs sm:text-sm">
                    ...
                    <div className="mt-3 text-[10px] sm:text-xs text-blue-300">
                      <div>📊 Precision: 6-7 digits</div>
                      <div>📝 Format: %f</div>
                    </div>
                  </div>

                  {/* double Card */}
                  <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-xl p-4 sm:p-5 border-l-4 border-green-500 shadow-md transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <code className="text-xl sm:text-2xl font-bold text-green-300">double</code>
                      <span className="bg-green-500/30 text-green-200 px-2 py-1 rounded text-[10px] sm:text-xs font-bold">8 bytes</span>
                    </div>
                    <p className="text-blue-200 text-xs sm:text-sm">Double precision floating point</p>
                    <div className="bg-black/50 rounded-lg p-3 mt-3 font-mono text-xs sm:text-sm">
                      <span className="text-pink-400">double</span><span className="text-white"> pi = </span><span className="text-emerald-400">3.14159</span><span className="text-white">;</span>
                    </div>
                    <div className="mt-3 text-[10px] sm:text-xs text-blue-300">
                      <div>📊 Precision: 15-16 digits</div>
                      <div>📝 Format: %lf</div>
                    </div>
                  </div>

                  {/* void Card */}
                  <div className="bg-gradient-to-br from-gray-500/20 to-slate-500/20 rounded-xl p-4 sm:p-5 border-l-4 border-gray-500 shadow-md transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <code className="text-xl sm:text-2xl font-bold text-gray-300">void</code>
                      <span className="bg-gray-500/30 text-gray-200 px-2 py-1 rounded text-[10px] sm:text-xs font-bold">0 bytes</span>
                    </div>
                    <p className="text-blue-200 text-xs sm:text-sm">No value / Empty type</p>
                    <div className="bg-black/50 rounded-lg p-3 mt-3 font-mono text-xs sm:text-sm whitespace-nowrap overflow-x-auto">
                      <span className="text-pink-400">void</span><span className="text-white"> fn(</span><span className="text-pink-400">void</span><span className="text-white">);</span>
                    </div>
                    <div className="mt-3 text-[10px] sm:text-xs text-blue-300">
                      <div>📊 Used for functions</div>
                      <div>📝 No void variables</div>
                    </div>
                  </div>

                  {/* long long Card */}
                  <div className="bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-xl p-4 sm:p-5 border-l-4 border-purple-500 shadow-md transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <code className="text-xl sm:text-2xl font-bold text-purple-300">long long</code>
                      <span className="bg-purple-500/30 text-purple-200 px-2 py-1 rounded text-[10px] sm:text-xs font-bold">8 bytes</span>
                    </div>
                    <p className="text-blue-200 text-xs sm:text-sm">Extended integer range</p>
                    <div className="bg-black/50 rounded-lg p-3 mt-3 font-mono text-xs sm:text-sm">
                      <span className="text-pink-400">long long</span><span className="text-white"> big = </span><span className="text-emerald-400">9E18</span><span className="text-white">;</span>
                    </div>
                    <div className="mt-3 text-[10px] sm:text-xs text-blue-300">
            ...
            <div className="w-full max-w-6xl mx-auto py-12 px-6">
              ...
              <AnimCard delay={0.15} className="bg-white/10 rounded-2xl shadow-xl backdrop-blur-md border border-white/10 p-8 mb-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                  {[
                    { name: 'Arithmetic', icon: '🔢', ops: '+ - * / % ++ --', desc: 'Calculations' },
                    { name: 'Relational', icon: '⚖️', ops: '== != > < >= <=', desc: 'Compare' },
                    { name: 'Logical', icon: '🔗', ops: '&& || !', desc: 'Conditions' },
                    { name: 'Bitwise', icon: '🧮', ops: '& | ^ ~ << >>', desc: 'Bit-level' },
                    { name: 'Assignment', icon: '📝', ops: '= += -= *= /=', desc: 'Assign' }
                  ].map((type, i) => (
                    <AnimCard key={i} delay={i * 0.1} className="bg-gradient-to-br from-purple-900/40 to-pink-900/30 rounded-xl p-3 sm:p-4 text-center border-2 border-purple-200 transition-all duration-500 hover:scale-105">
                      <div className="text-2xl sm:text-3xl mb-2">{type.icon}</div>
                      <h4 className="font-bold text-purple-300 text-xs sm:text-sm">{type.name}</h4>
                      <p className="text-[10px] text-blue-100/50 mt-1 font-mono">{type.ops}</p>
                      <p className="text-[10px] text-purple-300/60 mt-1">{type.desc}</p>
                    </AnimCard>
                  ))}
                </div>
              </AnimCard>
              ...
              <div className="bg-white/10 rounded-2xl backdrop-blur-md border border-white/10 p-8 mb-8 border-l-8 border-blue-500">
                ...
                <div className="mt-4 p-4 bg-blue-500/20 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                    {[
                      { icon: '📏', text: 'Fixed Size - Set at compile time' },
                      { icon: '🧱', text: 'Homogeneous - Same data type' },
                      { icon: '🔗', text: 'Contiguous Memory - Sequential' },
                      { icon: '0️⃣', text: 'Zero-based Indexing - Start at 0' },
                      { icon: '🎯', text: 'Direct Access - Fast retrieval' },
                    ].map((item, i) => (
                      <div key={i} className="flex items-center gap-3 p-3 bg-blue-800/30 rounded-xl border border-blue-400/20 shadow-sm">
                        <span className="text-xl">{item.icon}</span>
...
// Output: Square: 25, Max: 10`}
            ...
            {/* Complete Program */}
            <div className="bg-white/10 rounded-2xl backdrop-blur-md border border-white/10 p-8">
              <h3 className="text-2xl font-bold text-pink-300 mb-4">💻 Complete Program - All Function Types</h3>
              <div className="bg-black/50 rounded-lg overflow-hidden">
                <div className="bg-pink-800/30 px-3 py-1 border-b border-pink-500/30">
                  <span className="text-pink-300 text-sm">all_functions.c</span>
                </div>
                <pre className="p-5 text-sm font-mono text-blue-200">
                  {`#include <stdio.h>
              ...
              <div className="bg-white/10 rounded-2xl backdrop-blur-md border border-white/10 p-8 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    ...
                    <ul className="list-none  text-blue-200 text-base mt-2 space-y-2">
          ...
          <Slide>
            <div className="w-full max-w-6xl mx-auto py-12 px-6">
              ...
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white">Dynamic Memory Allocation</h2>
              </div>
                  ...
                  <div className="bg-blue-900/30 rounded-xl p-5">
                    ...
                    <div className="space-y-3 mt-4">
                      {[
                        ...
                        'Faster (no initialization)',
                        'Use when you\'ll initialize manually'
                      ].map((item, i) => (
                        <div key={i} className="flex items-center gap-3 p-3 bg-blue-800/20 rounded-xl border border-blue-400/20 text-blue-200">
                  ...
                  <div className="bg-green-900/30 rounded-xl p-5">
                    ...
                    <div className="space-y-3 mt-4">
                      {[
                        ...
                        'Zero-initialized',
                        'Slightly slower',
                        'Use when you need zeros'
                      ].map((item, i) => (
                        <div key={i} className="flex items-center gap-3 p-3 bg-green-800/20 rounded-xl border border-green-400/20 text-green-200">
          ...
          <Slide>
            <div className="w-full max-w-6xl mx-auto py-12 px-6">
              ...
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white">File Handling in C</h2>
              </div>
    ...
    hanoi(n-1, aux, to, from);
        ...
        <div className="slide-section">
          <Slide>
            ...
            <SlideItem delay={0.2}>
              <h2 className="text-6xl md:text-8xl font-black text-blue-700 mb-6 tracking-tight drop-shadow-lg">Congratulations!</h2>
            </SlideItem>
            <SlideItem delay={0.3}>
              <p className="text-2xl text-blue-900 font-medium max-w-3xl mb-8 leading-relaxed">
                You've mastered <strong className="text-blue-700 font-bold">22 C programming topics</strong> — from Hello World to Recursion! You now speak the language of operating systems! 🚀
              </p>
            </SlideItem>
            <SlideItem delay={0.4}>
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                {['Variables ✓', 'Pointers ✓', 'Arrays ✓', 'Strings ✓', 'Functions ✓', 'Structs ✓', 'Memory ✓', 'Files ✓', 'Recursion ✓'].map(b => (
                  <motion.span key={b} whileHover={{ scale: 1.1, rotate: 2 }} whileTap={{ scale: 0.9 }}
                    className="px-4 py-2 bg-blue-800/60 text-blue-200 backdrop-blur-md rounded-full font-bold text-sm border border-rose-300 cursor-pointer">
                    {b}
                  </motion.span>
                ))}
              </div>
            ...
            <SlideItem delay={0.5}>
              <p className="text-blue-700 text-lg mb-6">🤖 Use the chatbot (right panel) to test your knowledge!</p>
            </SlideItem>
            <SlideItem delay={0.6}>
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: '0 0 40px rgba(26, 8, 180, 0.3)' }}
                whileTap={{ scale: 0.95 }}
